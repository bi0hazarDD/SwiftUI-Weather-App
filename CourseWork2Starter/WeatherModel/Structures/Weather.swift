// Below are all the structures obtained from the API response , including a custom AddressDetails struct I made to house the values of the street, city, country
import Foundation
